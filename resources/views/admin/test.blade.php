                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <fieldset data-set="1">
                                <div class="form-card text-center" style="text-align:start">
                                    <h2 style="text-align:center" class="fs-title">  اختيار القرعة</h2>
                                    <div class="row box" style="text-align:center">
                                        <p style="text-align:center;margin: auto;font-size:2rem" id="number">0</p>

                                    </div>

                                    <div class="new" style="text-align: center;" dir="rtl" >
                                        <input type="submit" style="background:#008854;border:none" name="next" class="next action-button nextInfoBtn" value="حفظ" />


                                    </div>
                                </div>
                                <input onclick="rand()" type="button" style="background:#008854;border:none" name="next" class="next action-button nextInfoBtn" value="اعادة تعيين" />
...
<script>
    ...
    function rand (){
        let myInterval = setInterval(()=>{
            ...
            random = arr[Math.floor(Math.random()*501)+ 1]
    ...
    $(function () {
        ...
        $('#msform').submit(function (e) {
            ...
            setTimeout(()=>{result = parseInt(document.getElementById('number').innerHTML);
                console.log(result);

                var url = '/gami/savenumber/'+result;
                $.ajaxSetup({
                    headers: {
