                    ...
                    <div class="col-md-12 mx-0">
                        <form id="msform" action="{{ url()->current() }}" method="post" enctype="multipart/form-data">
                            ...
                            <fieldset data-set="1">
                                ...
                                </div><input type="submit" style="background:#008854;border:none" name="next" class="next action-button nextInfoBtn" value="اختيار جديد" />
    ...
    $(function () {
        ...
        $('#msform').submit(function (e) {
            ...
            setTimeout(()=>{
                ...
                result = parseInt(document.getElementById('number').innerHTML);
