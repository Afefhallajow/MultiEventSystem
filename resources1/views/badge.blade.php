...
<div  style="height:10.0cm;width:8.4cm;margin:auto">
       ...
       <div id="invitation_infoo">
        ...
        <br>
        <div  style="line-height:18px; position:absolute; width:8.5cm;text-align:center; top:12cm; color:#000; font-family:Arial; font-size:11pt;">
            <!--<a class="pdf" style="cursor:pointer;cursor: pointer;border: 1px solid #ccc;padding: 0.7rem;border-radius: 10px;" onclick="CreatePDFfromHTML()">Download</a> <br><br>-->
        </div>
</div>
