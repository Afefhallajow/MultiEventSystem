...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                <div class="card-header text-center"><h4>نموذج تسجيل زائر جديد</h4></div>
                <div class="card-body">
                     @if(Session::has('msg'))
                    <p style="background: #2cc52c;color: #fff;padding: 0 1rem;" class="alert alert-succrdd">{{ Session::get('msg') }}</p>
                    @endif
                    <form method="POST" id="addNewVisitor" enctype="multipart/form-data" action="{{ url()->current() }}">
                        @csrf
                        <div>
                            ...
                            <div id="form-step-1" role="form" data-toggle="validator">
                                ...
                                <div class="form-group mt-2col-12">
                                    <label class="form-label" for="mobile">رقم الجوال<span class="red">*</span></label>
                                    <div class="col-12 row">
                                        <select class="form-control col-3" required name="code">
                                        ...
                                        <input type="text" id="mobile" name="mobile" value="{{old("mobile")}}" class="form-control col-9" placeholder="561231233" required/>
                                    </div>
                                </div>
                                <div class="form-group mt-2col-12">
                                    <label class="form-label" for="email">البريدالالكتروني<span class="red">*</span></label>
                                    <input type="text" id="email" name="email" value="{{old("email") !="" ? old("email") : ""}}" class="form-control" placeholder="info@admin.com" required/>
                                </div>
                                <div class="form-group mt-2col-12">
                                    <label for="city"> الجنس <span class="red">*</span></label>
                                ...
                                <div class="form-group mt-2col-12">
                                    <label for="city">كيف علمت بالمعرض<span class="red">*</span></label>
                                    <select name="know_from" class="form-control" required>
                                            <option value="حسابات التواصل الاجتماعي">
                                                حسابات التواصل الاجتماعي</option>
                              ...
                              <div class="form-group mt-2col-12">
                                    <label for="city"> هل أنت من أعضاء مجلس التعاون الخليجي ؟ <span class="red">*</span></label>
                                ...
                                <div class="form-group mt-2col-12">
                                    <label for="city">هل تقيم في البحرين ؟ <span class="red">*</span></label>
                                    <select name="inBahreen" class="form-control" required>
                                        <option value="Yes">نعم</option>
                                        <option value="No">لا</option>
                                    </select>
                                </div> 
                                <div class="form-group mt-2col-12">
                                    <label for="city"> الجنسية <span class="red">*</span></label>
                                    <input type="text" name="nationality" class="form-control" required>
                                </div> 
                                <div class="form-group mt-2col-12">
                                    <label for="city">صورة عن جواز السفر </label>
                                    <input type="file" class="form-control" name="passportImage"/>
                                </div>
                                <h1 style="text-align:center">معلومات البادج</h1>
                                <div class="form-group mt-2col-12">
                                    <label class="form-label" for="badgeName">الاسم<span class="red">*</span></label>
                                    <input type="text" id="badgeName" name="badgeName" value="{{old("badgeName")}}" class="form-control"  required/>
                                </div>
                                <div class="form-group mt-2col-12">
                                    <label for="badgeSide">جهة العمل<span class="red">*</span></label>
                                    <input type="text" id="badgeSide" name="badgeSide" value="{{old("badgeSide")}}" class="form-control" placeholder="" required/>
                                </div>
                                <div class="form-group mt-2col-12">
                                    <label for="badgeJob">المسمى الوظيفي<span class="red">*</span></label>
                                    <input type="text" id="badgeJob" name="badgeJob" value="{{old("badgeJob")}}" class="form-control" placeholder="" required/>
                                </div>
