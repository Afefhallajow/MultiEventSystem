...
<body marginheight="0" topmargin="0" marginwidth="0" style="margin: 0px; background-color: #fff;" leftmargin="0" dir="rtl">
    ...
    style="@import url(//db.onlinewebfonts.com/c/593331e50d21b6415d53fc7c416b5b8e?family=FrutigerLTArabic-75Black); font-family: 'FrutigerLTArabic-75Black', sans-serif;">
                            ...
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1 style="color:#7ac0bb; font-weight:500; margin:0;font-size:25px;font-family:'FrutigerLTArabic-75Black',sans-serif;"> Thank You
                                        </h1>
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                         Your registration to attend the event has been confirmed
        ...
        <span style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
         <br>
        <h5 style="color:#455056; font-weight:500; margin:0;font-size:15px;font-family:'FrutigerLTArabic-75Black',sans-serif;"> 
                                        </h5>


                                       <a href="{{$link}}">
                                          <p  style="background:#7ac0bb;text-decoration:none !important; display:inline-block; font-weight:500; margin-top:24px; color:#fff;text-transform:uppercase; font-size:14px;padding:10px 24px;display:inline-block;border-radius:50px;">Click Here</p></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="height:40px;">&nbsp;</td>
