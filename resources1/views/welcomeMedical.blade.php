            ...
            <div class="card px-0 pb-0 mt-3 mb-3">
                ...
                <div class="row">
                    <div class="col-md-12 mx-0">
                        <form id="msform" action="https://emf5.net/saveMembersMedicalData" method="post" enctype="multipart/form-data">
                            @csrf
                            <fieldset data-set="1">
                                <div class="form-card">
                                    <h2 style="text-align:end" class="fs-title"> المعلومات الشخصية</h2>
                                    <div class="row box">
                                        ...
                                        <div class="col-md-12 div1">
                                            ...
                                            <input dir="rtl" type="email" id="email" name="email" placeholder="" />
                                    ...
                                    <div class="col-md-12  mobile-clas">
                                         <label for="member" class="float-right">رقم الجوال</label>
                                 <br>

                                            <input dir="rtl" type="number" pattern="\d*" maxlength="9" id="mobile" name="mobile" placeholder="" required />
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                </div><input type="submit" name="next" class="next action-button nextInfoBtn" value="تسجيل" />
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                       if(response == 0){
                                        ...
                                        window.location.replace('http://emf5.net/badge');
